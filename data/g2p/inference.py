# Copyright 2019 Kyubyong Park & Jongseok Kim. Apache-2.0.
# Adapted from g2p_en 2.1.0: inference only; removed NLTK, dictionary and text preprocessing.
# Model decoding now rejects sequences which never emit end-of-sequence.
...
class G2p(object):
    ...
    def load_variables(self):
        self.variables = np.load(Path(__file__).with_name('checkpoint20.npz'), allow_pickle=False)
    ...
    def predict(self, word):
        ...
        for i in range(20):
            ...
            raise ValueError("G2P decoder did not terminate")
